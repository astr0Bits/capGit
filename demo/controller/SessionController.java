...
import com.capstone.demo.dto.SessionRequestDto;
...
import com.capstone.demo.service.SessionService;
import com.capstone.demo.service.SkillOfferService;
...
public class SessionController {
    ...
    public ResponseEntity<?> requestSession(@RequestBody SessionRequestDto requestDto,
        ...
        try {
            ...
            if (learner.getCredits() < requestDto.getRequestedHours()) {
